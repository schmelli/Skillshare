...
<required_reading>
@/home/user/Skillshare/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@/home/user/Skillshare/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = /home/user/Skillshare/.claude
                  → checks /home/user/Skillshare/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = /home/user/Skillshare/.claude/gsd-core
                  → writes to /home/user/Skillshare/.claude/gsd-core/hooks/
...
@/home/user/Skillshare/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @/home/user/Skillshare/.claude/gsd-core/references/common-bug-patterns.md
