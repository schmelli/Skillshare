...
Reference full template: `/home/user/Skillshare/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `/home/user/Skillshare/.claude/gsd-core/templates/state.md`.
