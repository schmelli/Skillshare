...
<execution_context>
@/home/user/Skillshare/.claude/gsd-core/workflows/manager.md
...
Read and execute `/home/user/Skillshare/.claude/gsd-core/workflows/analyze-dependencies.md` end-to-end.
