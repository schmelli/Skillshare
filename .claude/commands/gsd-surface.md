...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `/home/user/Skillshare/.claude/.gsd-surface.json`
(sibling to `/home/user/Skillshare/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `/home/user/Skillshare/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`/home/user/Skillshare/.claude/skills`).
...
`/home/user/Skillshare/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `/home/user/Skillshare/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `/home/user/Skillshare/.claude/.gsd-surface.json`
Install profile marker: `/home/user/Skillshare/.claude/.gsd-profile`
Skill dirs: `/home/user/Skillshare/.claude/skills/gsd-*/`
Engine module: `/home/user/Skillshare/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `/home/user/Skillshare/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
