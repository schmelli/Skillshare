...
```
Agent(
  prompt="Read /home/user/Skillshare/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/home/user/Skillshare/.claude/gsd-core/templates/SECURITY.md`
