...
- [ ] **ORG-01**: Admin can create and manage workspaces (e.g. "Employment Law", "M&A", "Compliance")
- [ ] **ORG-02**: Admin can grant users per-workspace roles (Admin / Editor / Consumer)
- [ ] **ORG-03**: Users see only the workspaces and skills they are authorized for — in the dashboard and every API
